...
vanilla_Bonferroni_result_dir = paste(c(current_dir, "output/output_vanilla_Bonferroni_test"), collapse="/")
...
for(i1 in 1:length(K_vec)) {
  ...
  for(i2 in 1:length(I_vec)) {
    ...
    for(i3 in 1:length(Gamma_vec)) {
      ...
      Bonferroni_file_path = paste(c(vanilla_Bonferroni_result_dir, Bonferroni_file_name), collapse="/")
    ...
    power_file_path = paste(c(vanilla_Bonferroni_result_dir, power_file_name), collapse="/")
