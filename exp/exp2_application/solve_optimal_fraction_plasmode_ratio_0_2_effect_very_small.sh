#!/bin/bash
#SBATCH --job-name=solve_optimal_fraction_plasmode_ratio_0_2_effect_very_small      # create a short name for your job
...
Rscript solve_optimal_fraction_plasmode_ratio_0_2_effect_very_small.R
