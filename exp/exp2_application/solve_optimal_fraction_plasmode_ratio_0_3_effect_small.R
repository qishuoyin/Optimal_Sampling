...
# (generate 30% outcomes affected in plasmode dataset with effect size to be small: 0.05 - 0.20)
...
result_file_name = paste(c(paste(c("final_result", "method", method, "plasmode_ratio_0_3_effect_small"), collapse="_"), "csv"), collapse=".")
