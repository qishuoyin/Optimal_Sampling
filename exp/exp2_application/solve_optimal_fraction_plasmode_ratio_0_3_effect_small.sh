#!/bin/bash
#SBATCH --job-name=solve_optimal_fraction_plasmode_ratio_0_3_effect_small      # create a short name for your job
...
Rscript solve_optimal_fraction_plasmode_ratio_0_3_effect_small.R
